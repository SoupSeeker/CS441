...
class Digest(models.Model):
    ...
    def _compute_kpi_pos_total_value(self):
        if not self.env.user.has_group('nemo_pos.group_pos_user'):
    ...
    def _compute_kpis_actions(self, company, user):
        ...
        res['kpi_pos_total'] = 'nemo_pos.action_pos_sale_graph&menu_id=%s' % self.env.ref('nemo_pos.menu_point_root').id
        return res
