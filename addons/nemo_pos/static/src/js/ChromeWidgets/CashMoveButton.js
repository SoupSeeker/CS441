odoo.define('nemo_pos.CashMoveButton', function (require) {
    'use strict';
    ...
    class CashMoveButton extends PosComponent {
        async onClick() {
            ...
            if (this.env.pos.proxy.printer) {
                const renderedReceipt = this.env.qweb.renderToString('nemo_pos.CashMoveReceipt', {
    ...
    CashMoveButton.template = 'nemo_pos.CashMoveButton';
