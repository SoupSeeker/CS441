odoo.define('nemo_pos.ProductScreen', function(require) {
    'use strict';

    const PosComponent = require('nemo_pos.PosComponent');
    const ControlButtonsMixin = require('nemo_pos.ControlButtonsMixin');
    const NumberBuffer = require('nemo_pos.NumberBuffer');
    const { useListener } = require('web.custom_hooks');
    const Registries = require('nemo_pos.Registries');
    const { onChangeOrder, useBarcodeReader } = require('nemo_pos.custom_hooks');
    const { isConnectionError, posbus } = require('nemo_pos.utils');
