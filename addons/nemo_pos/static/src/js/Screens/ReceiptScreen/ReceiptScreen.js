odoo.define('nemo_pos.ReceiptScreen', function (require) {
    'use strict';

    const { Printer } = require('nemo_pos.Printer');
    const { is_email } = require('web.utils');
    const { useRef, useContext } = owl.hooks;
    const { useErrorHandlers, onChangeOrder } = require('nemo_pos.custom_hooks');
