...
odoo.define('nemo_pos.models', function (require) {
"use strict";

const { Context } = owl;
var BarcodeParser = require('barcodes.BarcodeParser');
var BarcodeReader = require('nemo_pos.BarcodeReader');
var PosDB = require('nemo_pos.DB');
var devices = require('nemo_pos.devices');
