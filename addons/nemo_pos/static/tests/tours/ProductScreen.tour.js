odoo.define('nemo_pos.tour.ProductScreen', function (require) {
    'use strict';

    const { ProductScreen } = require('nemo_pos.tour.ProductScreenTourMethods');
    const { TextAreaPopup } = require('nemo_pos.tour.TextAreaPopupTourMethods');
...
odoo.define('nemo_pos.tour.FixedPriceNegativeQty', function (require) {
    'use strict';
