odoo.define('nemo_pos.tour.TicketScreen', function (require) {
    'use strict';
    ...
    const { TicketScreen } = require('nemo_pos.tour.TicketScreenTourMethods');
    const { ErrorPopup } = require('nemo_pos.tour.ErrorPopupTourMethods');
    const { Chrome } = require('nemo_pos.tour.ChromeTourMethods');
    const { getSteps, startSteps } = require('nemo_pos.tour.utils');
