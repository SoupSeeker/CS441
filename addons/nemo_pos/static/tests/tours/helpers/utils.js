odoo.define('nemo_pos.tour.utils', function (require) {
    'use strict';
     ...
     *
     * ```
     * const { startSteps, getSteps, createTourMethods } = require('nemo_pos.utils');
     * const { Other } = require('nemo_pos.tour.OtherMethods');
     *
